...
import com.example.videoyt.adapters.CommentAdapter;
import com.example.videoyt.models.YoutubeCommentModel;
import com.example.videoyt.models.YoutubeDataModel;

public class DetailsActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    private static final int READ_STORAGE_PERMISSION_REQUEST_CODE = 1;
    private static String GOOGLE_YOUTUBE_API = "[API KEY HERE]";//here you should use your api key for testing purpose you can use this api also
